...
**Latest:** [**v0.1.4**](https://github.com/ccl6075316-afk/game-ai-foundry/releases/tag/v0.1.4) — 纯净机开箱（可迁移 Python）+ 审查回填 + IT 实例配置
...
1. 下载 [**v0.1.4 Release**](https://github.com/ccl6075316-afk/game-ai-foundry/releases/tag/v0.1.4)（Windows 推荐 **`*-setup.exe`**）
...
说明 → [`docs/RELEASE-NOTES-0.1.4.md`](docs/RELEASE-NOTES-0.1.4.md) · 打包 → [`docs/RELEASE.md`](docs/RELEASE.md)
