...
**Latest:** [**v0.1.3**](https://github.com/ccl6075316-afk/game-ai-foundry/releases/tag/v0.1.3) — 修复安装包启动崩溃（electron-updater ESM）
...
1. 下载 [**v0.1.3 Release**](https://github.com/ccl6075316-afk/game-ai-foundry/releases/tag/v0.1.3)（Windows 推荐 **`*-setup.exe`**）
...
说明 → [`docs/RELEASE-NOTES-0.1.3.md`](docs/RELEASE-NOTES-0.1.3.md) · 打包 → [`docs/RELEASE.md`](docs/RELEASE.md)
