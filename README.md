...
**Latest:** [**v0.2.1**](https://github.com/ccl6075316-afk/game-ai-foundry/releases/tag/v0.2.1) — Brief 目录分册 + 文档焦点预览 + 应用内媒体灯箱
...
1. 下载 [**v0.2.1 Release**](https://github.com/ccl6075316-afk/game-ai-foundry/releases/tag/v0.2.1)（Windows 推荐 **`*-setup.exe`**）
...
说明 → [`docs/RELEASE-NOTES-0.2.1.md`](docs/RELEASE-NOTES-0.2.1.md) · 打包 → [`docs/RELEASE.md`](docs/RELEASE.md)
